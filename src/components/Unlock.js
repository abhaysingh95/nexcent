  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-center m-0 mb-20 bg-white p-4">
      <div className="md:w-1/2 flex justify-center mb-6 md:mb-0">
        <img src="./unlock.png" alt="Unlock" className="w-96 h-82 object-cover"/>
      </div>
      <div className="md:w-1/2 p-4">
        <h1 className="text-5xl text-[#4D4D4D] font-bold leading-tight mb-4">The unseen of spending three years at PixelGrade</h1>
